...
if (args.length === 0) {
  ...
  console.log('Usage: npm run install -- --tool codex-cli | --bundle <slug> | --skill <slug> [--dry-run] [--path <dir>]');
  console.log('Tip: add --tool to install all skills for a target profile. Use --list to view available options.');
  process.exit(0);
}
